...
class RejectedTab extends StatelessWidget {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          _rowInfo(context, Icons.group_outlined, "Quantity: ${post.quantity ?? 0}"),
                          _rowInfo(context, Icons.access_time, "Pickup: ${post.pickupTime ?? 'Not Available'}"),
                          _rowInfo(context, Icons.location_on_outlined, post.pickupAddress ?? "No Address Provided"),
  ...
  Widget _buildImage(List<String>? urls, bool isDark) { // ✅ Nullable list handling
    return ClipRRect(
      borderRadius: BorderRadius.circular(12),
      child: Container(
        width: 80,
