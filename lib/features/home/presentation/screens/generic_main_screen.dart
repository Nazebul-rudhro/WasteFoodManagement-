  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        // 🔹 কালার লজিক ফিক্স:
        // বারের মেইন ব্যাকগ্রাউন্ড ডার্ক মোডে কালো হবে, লাইট মোডে সাদা
        color: isDark ? const Color(0xFF1E1E1E) : Colors.white,

        // সিলেক্টেড আইকনের গোল ব্যাকগ্রাউন্ড
        buttonBackgroundColor: isDark ? AppColor.green : AppColor.lightGreen,

        // বারের বাইরের ট্রান্সপারেন্ট অংশ (Scaffold ব্যাকগ্রাউন্ডের সাথে মিল রাখা হয়েছে)
