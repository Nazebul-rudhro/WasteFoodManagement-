...
//       name: "Sks",
//       distance: "2.5km",
//       image: "assets/images/splash_screen/splashscreen_1.png", location: 'acdd', foodRequirement: '',
//     ),
//     NGOModel(
//       name: "Hope NGO",
//       distance: "1.2km",
...
//
//             HeaderSection(
//                 name: "Mandeep", role: "Donner", notificationCount: 1, noticicationOnActionTap: () { Navigator.pushNamed(context, DonorNotificationScreen.routeName); },),
          ...
          child: BaseScreen(
            child: Column(
              ...
              children: [
                ...
                NgoNearYouSection(
                  onActionTap: () {
                    Navigator.push(context, AppRoutes.smooth(const NgoListScreen()));
                  },
                ),
