...
//           context, GenericInformationFormScreen.routeName);
//     } else {
//       switch (role) {
//         case 'donor':
...
//                   /// Title
//
//                    Text("Login", style: AppData.heading1.copyWith(color: Colors.green)),
//
//
//                   SizedBox(height: gap),
//
...
//                                 return AppColor.lightGreen; // clicked হলে background
//                               }
//                               return AppColor.lightGreen.withOpacity(0.3); // normal state
//                             }),
//
//                            value: rememberMe,
//                             onChanged: (val) =>
...
//                         child:  Text("Forgot Password?", style: TextStyle(color: AppColor.lightGreen),),
//                       ),
//                     ],
//                   ),
//                   SizedBox(height: gap),
...
//                         child:  Text(
//                           "SignUp",
//                           style: TextStyle(color: AppColor.lightGreen, fontWeight: FontWeight.bold,),
//                         ),
//                       ),
//                     ],
//                   ),
